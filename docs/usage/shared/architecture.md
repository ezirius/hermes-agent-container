...
- `scripts/agent/shared/hermes-agent-run` and `scripts/agent/shared/hermes-agent-shell` open interactive commands through exact-name CLI containers named `<image-name>-<workspace>-cli`.
