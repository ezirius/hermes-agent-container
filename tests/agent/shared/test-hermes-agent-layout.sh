...
grep -q 'Container and pod names use the OpenCode-derived `<image-name>-<workspace>` order' "$ROOT/docs/usage/shared/usage.md"
...
grep -q 'Runtime container and pod names use `<image-name>-<workspace>`' "$ROOT/README.md"
...
grep -q 'container and pod names follow `<image-name>-<workspace>`' "$ROOT/docs/usage/shared/architecture.md"
...
grep -q 'Hermes container and pod names follow the OpenCode-derived `<image-name>-<workspace>` order' "$ROOT/AGENTS.md"
