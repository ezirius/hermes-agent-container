...
grep -q 'exact name `<image-name>-<workspace>-cli`' "$ROOT/docs/usage/shared/usage.md"
grep -q 'removes stale stopped same-workspace exact-name containers before launch' "$ROOT/docs/usage/shared/usage.md"
...
grep -q 'exact-name CLI containers named `<image-name>-<workspace>-cli`' "$ROOT/docs/usage/shared/architecture.md"
grep -q 'clears stale stopped same-workspace exact-name CLI containers before launch' "$ROOT/docs/usage/shared/architecture.md"
