...
grep -q 'temporary exact name `<image-name>-<workspace>-cli`' "$ROOT/docs/usage/shared/usage.md"
grep -q 'renames them to `<image-name>-<workspace>-cli-<12char-container-id>`' "$ROOT/docs/usage/shared/usage.md"
grep -q 'removes that renamed container on exit' "$ROOT/docs/usage/shared/usage.md"
...
grep -q 'temporary exact name `<image-name>-<workspace>-cli`' "$ROOT/README.md"
grep -q '`<image-name>-<workspace>-cli-<12char-container-id>`' "$ROOT/README.md"
...
grep -q 'rename them to `<image-name>-<workspace>-cli-<12char-container-id>` before attach' "$ROOT/docs/usage/shared/architecture.md"
grep -q 'reclaims stale renamed same-workspace CLI session containers from interrupted runs' "$ROOT/docs/usage/shared/architecture.md"
...
grep -q 'renamed to `<image-name>-<workspace>-cli-<12char-container-id>` before attach' "$ROOT/AGENTS.md"
grep -q 'may only remove stale same-workspace temporary exact-name or renamed session containers' "$ROOT/AGENTS.md"
