...
test -f "$ROOT/config/patches/apply-hermes-mautrix-migration.py"
test -f "$ROOT/config/patches/templates/hermes-matrix-mautrix.py"
...
grep -q '^  && python3 /tmp/hermes-patches/apply-hermes-mautrix-migration.py \\$' "$ROOT/config/containers/Dockerfile"
grep -q 'npx playwright install --with-deps chromium' "$ROOT/config/containers/Dockerfile"
...
grep -q 'gateway/platforms/matrix.py' "$ROOT/config/patches/apply-hermes-mautrix-migration.py"
grep -q 'mautrix' "$ROOT/config/patches/apply-hermes-mautrix-migration.py"
grep -q 'base58>=2.1.1,<3' "$ROOT/config/patches/apply-hermes-mautrix-migration.py"
grep -q 'class MatrixAdapter' "$ROOT/config/patches/templates/hermes-matrix-mautrix.py"
...
grep -q '^exec_podman_interactive_command run "\${RUN_ARGS\[@\]}"$' "$ROOT/scripts/shared/hermes-open"
...
grep -q '"\$HERMES_IMAGE_NAME")' "$ROOT/scripts/shared/hermes-open"
grep -q '^exec_podman_interactive_command run \\$' "$ROOT/scripts/shared/hermes-shell"
grep -q -- '--entrypoint /bin/bash' "$ROOT/scripts/shared/hermes-shell"
grep -q '"\$HERMES_IMAGE_NAME"$' "$ROOT/scripts/shared/hermes-shell"
