...
grep -q 'python-olm>=3.2.16,<4' "$ROOT/config/patches/apply-hermes-mautrix-migration.py"
grep -q 'unpaddedbase64>=2.1.0,<3' "$ROOT/config/patches/apply-hermes-mautrix-migration.py"
